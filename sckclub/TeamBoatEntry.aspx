<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamBoatEntry.aspx.cs" Inherits="sckreg.TeamBoatEntry" %>
...
<body>
    ...
    <div id="divID2Seats">
       <table id="tblAdd2Seater" border="1" cellpadding="3">
            ...
            <tbody>
                <tr>
                    <td><asp:LinkButton ID="lnkButAddBoat" runat="server" 
                           BackColor="#6699FF" ForeColor="White" AutoPostBack="true"
                            PostBackUrl="TeamBoatEntry.aspx?qmeet={0}&qev={1}&qclub={2}&qpaddler={3}&qaction=ADD" 
                    ...
                    <td> 
                        <asp:LinkButton ID="lnkButDissolve2Boat" runat="server"
                         BackColor="#CC3300" ForeColor="White" AutoPostBack="true"
                            
                            
                            PostBackUrl="TeamBoatEntry.aspx?qmeet={0}&qev={1}&qclub={2}&qpaddler={3}&qaction=DIS" 
                    ...
                    <td> 
                        ...
                        BackColor="Red" ForeColor="White" AutoPostBack="true"                        
                            PostBackUrl="TeamBoatEntry.aspx?qmeet={0}&qev={1}&qclub={2}&qpaddler={3}&qaction=DEL" 
        ...
        <asp:Label ID="lblMessage2Seater" runat="server" Text="ErrMessage for 2 Seater"></asp:Label><br />
    </div>
    <div>
        <br />
        ...
        <asp:SqlDataSource ID="sqldataTeamBoatsbyEvent" runat="server" 
            ...
            SelectCommand="sp_sTeamBoatsInEventByTeam" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="TH15.102" Name="eventId" 
